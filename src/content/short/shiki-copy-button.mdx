...
Astro 提了了 [`<Content />`组件](https://docs.astro.build/en/guides/markdown-content/#the-content--component),
通过 `components` 可以对 MDX组件进行映射替换

下面将 pre 组件传入到 Content 组件中就可以实现带拷贝功能的 pre 组件
